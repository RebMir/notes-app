                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    <div>
                        <input
                            ...
                            className='w-full px-3 py-2 bg-gray-700 text-white border border-gray-600 rounded-md outline-none focus:ring-2 focus:ring-blue-600'
                            required
                        />
                    </div>
                    <div>
                    ...
                    <div className='flex space-x-2'>
                        ...
                        <button type='button' className='bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-blue-700'>
                            Cancel
                        </button>
                    </div>
                </form>
